...
class SuperAdminControllerIT {
    ...
    /**
     * On mock le CommandLineRunner pour éviter
     * toute initialisation automatique de données
     */
    @MockBean
    ...
    void deleteUser_shouldRemoveUser() throws Exception {
        ...
        assertThat(utilisateurRepository.findById(userToDelete.getId()))
                .isEmpty();
    }
    ...
    /**
     * Utilisateur authentifié MAIS pas SUPERADMIN
     ...
     */
    @Test
    void redirectToLogin_ifNotAuthenticated() throws Exception {
